...
export const constantRoutes = [
  ...
  {
    path: '/certificate/show',
    name: 'Certificate',
    component: () => import('@/views/certificate/certificate-show'),
    hidden: true
  },
  {
    path: '/',
...
export const asyncRoutes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'exam/sing-up',
        component: () => import('@/views/paper/exam/signUp'),
        name: 'SignUpOnline',
...

      {
        ...
        component: () => import('@/views/certificate/certificate-list'),
        name: 'ListCertificate',
        meta: { title: '我的证书', noCache: true, icon: 'results' }
      },

      {
        path: 'exam/certificate-show',
        component: () => import('@/views/certificate/certificate-show'),
        name: 'CertificateShow',
        meta: { title: '查看证书', noCache: true, icon: 'results' },
        hidden: true
      },
