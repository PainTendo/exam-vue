      ...
      <template slot="data-columns">
        ...
        >
          ...
          <template slot-scope="scope">
            <span v-if="scope.row.maxScore===-1">-</span>
        ...
        >
          ...
          <template slot-scope="scope">
            <span v-if="scope.row.maxScore===-1" style="color: #ff0000;">待批阅</span>
            <span v-if="scope.row.passed&&scope.row.maxScore!==-1" style="color: #00ff00;">通过</span>
            <span v-if="!scope.row.passed&&scope.row.maxScore!==-1" style="color: #ff0000;">未通过</span>
          </template>
