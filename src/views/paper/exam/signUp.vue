<template>
  ...
  >
    ...
    <template slot="data-columns">
      ...
      >
        <template slot-scope="scope">
          <el-button v-if="scope.row.state===0||scope.row.state===2" icon="el-icon-caret-right" type="primary" size="mini" @click="handleSignUp(scope.row.id)">报名</el-button>
...
import { signUp } from '@/api/exam/exam'
export default {
